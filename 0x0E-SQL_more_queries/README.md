...
0- Write a script that lists all privileges of the MySQL users user_0d_1 and user_0d_2 on your server.
...
100- Import the database dump from hbtn_0d_tvshows to your MySQL server: download (same as 16-shows_by_genre.sql)
...
101- Import the database dump from hbtn_0d_tvshows to your MySQL server: download (same as 100-not_my_genres.sql)
...
102- Import the database hbtn_0d_tvshows_rate dump to your MySQL server: download
...
103- Import the database dump from hbtn_0d_tvshows_rate to your MySQL server: download (same as 102-rating_shows.sql)
