...
100- Improve the files model_city.py and model_state.py, and save them as relationship_city.py and relationship_state.py:
...
101- Write a script that lists all State objects, and corresponding City objects, contained in the database hbtn_0e_101_usa
...
102- Write a script that lists all City objects from the database hbtn_0e_101_usa
